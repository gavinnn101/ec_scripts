package com.gavin101.accbuilder.leafs.cooking;

import com.gavin101.accbuilder.constants.cooking.Cooking;
    ...
    public int onLoop() {
        ...
        if (cookWidget != null && cookWidget.isVisible()) {
            ...
            if (cookingObject != null && cookingObject.canReach()) {
                ...
                Walking.walk(Cooking.LUMBRIDGE_CASTLE_RANGE_AREA.getRandomTile());
            }
