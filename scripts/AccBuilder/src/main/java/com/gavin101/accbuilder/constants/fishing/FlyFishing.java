...
public class FlyFishing {
    ...
    public static InventoryLoadout FLY_FISHING_INVENTORY = new InventoryLoadout()
            ...
            .addReq(ItemID.FEATHER, GLib.getRandomInt(1000, 2001)) // Withdraw between 1000-2000 feathers
            .setEnabled(() -> !Inventory.contains(ItemID.FEATHER))
            .setRefill(GLib.getRandomInt(3000, 4001)) // Buy between 3000-4000 feathers if we don't have enough for our withdraw amount
